...
bar_heights.append(bar_height3)
bar_heights.append(bar_height2)
bar_heights.append(bar_height1)


desvio.append(desvio3_)
desvio.append(desvio2_)
desvio.append(desvio1_)
...
plt.bar(bar_names, bar_heights, yerr = desvio)
plt.show()
